		...
		<div class="container first-child">
			<div class="row">
				<div class="col-sm-7 col-sm-offset-1 hidden-xs">
					<h2><i class="fa fa-desktop"></i> &nbsp; Web TV</h2>
				</div>
				<div class="col-sm-3">
					<div class="col-12-xs">
						<a href="<?php echo base_url('user/tv/add'); ?>" class="btn btn-md btn-block btn-primary"><i class="fa fa-plus"></i> &nbsp; Add Video</a>
					</div>
				</div>
			</div>
		</div>
										...
										<div class="image-placeholder">
											...
											<div class="col-sm-12" style="border-top:1px solid #ddd;padding-top:10px">
												<div class="btn-group btn-group-justified">
													<a class="btn btn-default btn-sm " href="' . base_url('user/tv/edit/' . $c['tvSlug']) . '"><i class="btn-icon-only fa fa-edit"></i> ' . phrase('edit') . '</a>
