...
<style>
   ...
   function get_circulars()
   {
	...
	return`<div class="flex-row">
					                   		     					...
					                   		     					<span class="span-2"><a href="http://kuzhithuraidiocese.com/circular/${val.c_slug}">${val.c_title} </a></span>
					                   		     					<span><div class="btn-group"><a class="btn btn-default btn-sm" href="http://kuzhithuraidiocese.com/circular/${val.c_slug}" data-push="tooltip" data-placement="top" title="" data-original-title="Remove">View</a></div></span>
					                   								 </div>`;
